  ...
  return (
    <div>
        <div class="  pt-16 pb-2 px-6 text-left dark:bg-neutral-900">
         ...
         <div class=" mt-16 py-2 px-8 text-left dark:bg-neutral-900">
            ...
            <p className='max-w-2xl ml-64 mb-6 text-black leading-both text-cap text-24 font-normal'>
            En nuestro espacio acogedor, te invitamos a sumergirte en un mundo de sabores exquisitos. Ya sea que estés buscando una indulgencia solitaria, un lugar para celebrar o simplemente disfrutar de un capricho diario, Gelatella es el destino perfecto para satisfacer tus antojos de helado.
            </p>
